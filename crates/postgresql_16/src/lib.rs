...
//! Replication uses the shared protocol runtime with an explicit PostgreSQL 16
...
pub use postgresql_15::CAPABILITY_MANIFEST_16 as CAPABILITY_MANIFEST;
...
impl change_event::SinkAdapter for SinkAdapter {
    ...
    fn capability_manifest(&self) -> change_event::CapabilityManifest {
        postgresql_15::capability_manifest_for_version("16")
    }

    fn qualify(&self, transaction: &change_event::ValidatedTransaction) -> std::io::Result<()> {
        postgresql_15::SinkAdapter::new_for_version("16").qualify(transaction)
    }
    ...
    fn plan(
        ...
        postgresql_15::SinkAdapter::new_for_version("16").plan(transaction)
    }
}
...
pub fn compatibility_manifest(
    ...
    postgresql_15::compatibility_manifest_for_version(target_build, "16")
}
...
pub fn sql(transaction: &change_event::ValidatedTransaction) -> std::io::Result<SqlTransaction> {
    postgresql_15::sql_for_version("16", transaction)
}
...
pub fn sql_with_plans(
    ...
    postgresql_15::sql_with_plans_for_version("16", transaction, plans)
}
...
pub async fn probe_target(
    ...
    postgresql_15::probe_target_for_version(config, schema, table, column, "16").await
}
